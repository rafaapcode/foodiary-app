...
export type OnboardingStackScreenProps<TRouteName extends keyof OnboardingStackParamList> = NativeStackScreenProps<OnboardingStackParamList, TRouteName>;
export type OnboardingStackRouteProps<TRouteName extends keyof OnboardingStackParamList> = RouteProp<OnboardingStackParamList, TRouteName>;
